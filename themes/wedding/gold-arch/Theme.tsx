        ...
        <div className={styles.card} ref={cardRef}>
          ...
          <div className={styles.content}>
            ...
            {showQrCode && guestToken && (
              <div style={{ textAlign: "center", margin: "2rem 0 0", padding: "1.8rem 1rem", borderTop: "1px solid rgba(184,146,60,0.2)" }}>
                <p style={{ fontFamily: "Marcellus, serif", fontSize: "0.7rem", letterSpacing: ".25em", textTransform: "uppercase", color: "var(--gold-deep, #B8923C)", marginBottom: "1.2rem", opacity: 0.8 }}>
                  Votre QR code d&apos;entrée
                </p>
                <div style={{ display: "inline-block", background: "#FCFAF5", padding: "14px", borderRadius: 12, boxShadow: "0 2px 18px rgba(184,146,60,0.15)" }}>
                  <QRCodeSVG
                ...
                <p style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "0.85rem", color: "#5C3B1A", marginTop: "1rem", opacity: 0.75 }}>
